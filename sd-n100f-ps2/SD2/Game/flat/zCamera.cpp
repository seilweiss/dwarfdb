...
typedef int32(*type_68)(xBase*, xBase*, uint32, float32*, xBase*);
typedef void(*type_69)(_xEnt*);
typedef void(*type_70)(RxNodeDefinition*);
typedef void(*type_72)(_xEnt*, _xScene*, float32, _xEntCollis*);
typedef uint32(*type_74)(xAnimTransition*, xAnimSingle*, void*);
typedef void(*type_77)(_xEnt*, _xVec3*);
typedef int32(*type_78)(RxPipelineNode*);
typedef uint32(*type_79)(_xEnt*, _xEnt*, _xScene*, float32, _xCollis*);
typedef void(*type_80)(RxPipelineNode*);
typedef RwObjectHasFrame*(*type_86)(RwObjectHasFrame*);
typedef void(*type_90)(_xEnt*, _xVec3*);

typedef uint8 type_1[8];
typedef uint8 type_4[8];
typedef uint8 type_6[8];
typedef uint8 type_9[8];
...
typedef zCutsceneZbuffer type_49[4];
...
typedef int32 type_60[2];
typedef RwFrustumPlane type_62[6];
typedef int8 type_64[128];
typedef uint32 type_65[2];
typedef int32 type_66[2];
typedef uint32 type_67[2];
typedef uint32 type_71[43];
typedef RwV3d type_73[8];
typedef uint32 type_75[2];
typedef xBase* type_76[43];
...
zGlobals globals;
int32(*zCameraEventCB)(xBase*, xBase*, uint32, float32*, xBase*);

int32 zCameraEventCB(xBase* to, uint32 toEvent);
void zCameraLoad(_tagxCam* ent, xSerial* s);
void zCameraSave(_tagxCam* ent, xSerial* s);
void zCameraInit(xBase* b, xCamAsset* asset);

// zCameraEventCB__FP5xBaseP5xBaseUiPfP5xBase
// Start address: 0x18ec40
int32 zCameraEventCB(xBase* to, uint32 toEvent)
{
	// Line 99, Address: 0x18ec40, Func Offset: 0
	// Line 103, Address: 0x18ec44, Func Offset: 0x4
	// Line 106, Address: 0x18ec64, Func Offset: 0x24
	// Line 107, Address: 0x18ec74, Func Offset: 0x34
	// Line 111, Address: 0x18ec7c, Func Offset: 0x3c
	// Line 116, Address: 0x18ec88, Func Offset: 0x48
	// Line 115, Address: 0x18ec8c, Func Offset: 0x4c
	// Line 116, Address: 0x18ec90, Func Offset: 0x50
	// Func End, Address: 0x18ec98, Func Offset: 0x58
}

// zCameraLoad__FP8_tagxCamP7xSerial
// Start address: 0x18eca0
void zCameraLoad(_tagxCam* ent, xSerial* s)
{
	// Line 79, Address: 0x18eca0, Func Offset: 0
	// Func End, Address: 0x18eca8, Func Offset: 0x8
}

// zCameraSave__FP8_tagxCamP7xSerial
// Start address: 0x18ecb0
void zCameraSave(_tagxCam* ent, xSerial* s)
{
	// Line 60, Address: 0x18ecb0, Func Offset: 0
	// Func End, Address: 0x18ecb8, Func Offset: 0x8
}

// zCameraInit__FP5xBaseP9xCamAsset
// Start address: 0x18ecc0
void zCameraInit(xBase* b, xCamAsset* asset)
{
	// Line 22, Address: 0x18ecc0, Func Offset: 0
	// Line 24, Address: 0x18ecd4, Func Offset: 0x14
	// Line 29, Address: 0x18ecdc, Func Offset: 0x1c
	// Line 30, Address: 0x18ece8, Func Offset: 0x28
	// Line 33, Address: 0x18ecf0, Func Offset: 0x30
	// Line 35, Address: 0x18ecfc, Func Offset: 0x3c
	// Func End, Address: 0x18ed10, Func Offset: 0x50
}
