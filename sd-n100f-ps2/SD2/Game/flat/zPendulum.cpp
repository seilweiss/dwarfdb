...
typedef uint32(*type_15)(_xEnt*, _xEnt*, _xScene*, float32, _xCollis*);
...
typedef void(*type_47)(xMemPool*, void*);
...
typedef zCutsceneZbuffer type_70[4];
typedef int8 type_71[16];
typedef zGlobalGameStats type_72[30];
...
typedef zGlobalGameStats type_80[4];
typedef int32 type_82[2];
...
zGlobals globals;
void(*zPendulumTranslate)(_xEnt*, _xVec3*);
int32(*zPendulumEventCB)(xBase*, xBase*, uint32, float32*, xBase*);
void(*zPendulum_Move)(_zPendulum*, _xScene*, float32, _xEntFrame*);
void(*zPendulum_Update)(_zPendulum*, _xScene*, float32);

int32 zPendulumEventCB(xBase* to, uint32 toEvent, float32* toParam);
void zPendulumTranslate(_xEnt* xent, _xVec3* dpos);
void zPendulum_Move(_zPendulum* pend, _xScene* s, float32 dt, _xEntFrame* frame);
void zPendulum_Update(_zPendulum* pend, _xScene* sc, float32 dt);
void zPendulum_Reset(_zPendulum* pend, _xScene* sc);
void zPendulum_Setup(_zPendulum* pend, _xScene* sc);
...
// zPendulumEventCB__FP5xBaseP5xBaseUiPfP5xBase
// Start address: 0x1a0be0
int32 zPendulumEventCB(xBase* to, uint32 toEvent, float32* toParam)
{
	_zPendulum* pend;
	// Line 195, Address: 0x1a0be0, Func Offset: 0
	// Line 203, Address: 0x1a0be4, Func Offset: 0x4
	// Line 206, Address: 0x1a0c88, Func Offset: 0xa8
	// Line 207, Address: 0x1a0c90, Func Offset: 0xb0
	// Line 210, Address: 0x1a0c98, Func Offset: 0xb8
	// Line 211, Address: 0x1a0ca0, Func Offset: 0xc0
	// Line 214, Address: 0x1a0ca8, Func Offset: 0xc8
	// Line 215, Address: 0x1a0cb8, Func Offset: 0xd8
	// Line 218, Address: 0x1a0cc0, Func Offset: 0xe0
	// Line 219, Address: 0x1a0cc8, Func Offset: 0xe8
	// Line 222, Address: 0x1a0cd0, Func Offset: 0xf0
	// Line 223, Address: 0x1a0cd8, Func Offset: 0xf8
	// Line 226, Address: 0x1a0ce0, Func Offset: 0x100
	// Line 228, Address: 0x1a0cec, Func Offset: 0x10c
	// Line 229, Address: 0x1a0cf0, Func Offset: 0x110
	// Line 232, Address: 0x1a0cf8, Func Offset: 0x118
	// Line 235, Address: 0x1a0d04, Func Offset: 0x124
	// Line 245, Address: 0x1a0d0c, Func Offset: 0x12c
	// Line 251, Address: 0x1a0d1c, Func Offset: 0x13c
	// Line 250, Address: 0x1a0d20, Func Offset: 0x140
	// Line 251, Address: 0x1a0d24, Func Offset: 0x144
	// Func End, Address: 0x1a0d2c, Func Offset: 0x14c
}

// zPendulumTranslate__FP5_xEntP6_xVec3
// Start address: 0x1a0d30
void zPendulumTranslate(_xEnt* xent, _xVec3* dpos)
{
	_zPendulum* pend;
	// Line 175, Address: 0x1a0d30, Func Offset: 0
	// Line 178, Address: 0x1a0d44, Func Offset: 0x14
	// Line 179, Address: 0x1a0d4c, Func Offset: 0x1c
	// Line 180, Address: 0x1a0d58, Func Offset: 0x28
	// Func End, Address: 0x1a0d6c, Func Offset: 0x3c
}

// zPendulum_Move__FP10_zPendulumP7_xScenefP10_xEntFrame
// Start address: 0x1a0d70
void zPendulum_Move(_zPendulum* pend, _xScene* s, float32 dt, _xEntFrame* frame)
{
	// Line 170, Address: 0x1a0d70, Func Offset: 0
	// Func End, Address: 0x1a0d78, Func Offset: 0x8
}

// zPendulum_Update__FP10_zPendulumP7_xScenef
// Start address: 0x1a0d80
void zPendulum_Update(_zPendulum* pend, _xScene* sc, float32 dt)
{
	float32 t;
	p2EntMotionPenData* aspen;
	// Line 149, Address: 0x1a0d80, Func Offset: 0
	// Line 151, Address: 0x1a0d8c, Func Offset: 0xc
	// Line 155, Address: 0x1a0d94, Func Offset: 0x14
	// Line 156, Address: 0x1a0d98, Func Offset: 0x18
	// Line 153, Address: 0x1a0d9c, Func Offset: 0x1c
	// Line 156, Address: 0x1a0da0, Func Offset: 0x20
	// Line 157, Address: 0x1a0db0, Func Offset: 0x30
	// Line 159, Address: 0x1a0db8, Func Offset: 0x38
	// Line 160, Address: 0x1a0ddc, Func Offset: 0x5c
	// Line 161, Address: 0x1a0de4, Func Offset: 0x64
	// Line 162, Address: 0x1a0e10, Func Offset: 0x90
	// Line 164, Address: 0x1a0e18, Func Offset: 0x98
	// Line 165, Address: 0x1a0e20, Func Offset: 0xa0
	// Func End, Address: 0x1a0e30, Func Offset: 0xb0
}

// zPendulum_Reset__FP10_zPendulumP7_xScene
// Start address: 0x1a0e30
void zPendulum_Reset(_zPendulum* pend, _xScene* sc)
{
	p2EntMotionPenData* aspen;
	// Line 120, Address: 0x1a0e30, Func Offset: 0
	// Line 122, Address: 0x1a0e44, Func Offset: 0x14
	// Line 124, Address: 0x1a0e4c, Func Offset: 0x1c
	// Line 126, Address: 0x1a0e58, Func Offset: 0x28
	// Line 129, Address: 0x1a0e5c, Func Offset: 0x2c
	// Line 128, Address: 0x1a0e68, Func Offset: 0x38
	// Line 129, Address: 0x1a0e6c, Func Offset: 0x3c
	// Line 128, Address: 0x1a0e70, Func Offset: 0x40
	// Line 129, Address: 0x1a0e74, Func Offset: 0x44
	// Line 130, Address: 0x1a0e7c, Func Offset: 0x4c
	// Line 129, Address: 0x1a0e88, Func Offset: 0x58
	// Line 130, Address: 0x1a0e94, Func Offset: 0x64
	// Line 131, Address: 0x1a0ea4, Func Offset: 0x74
	// Line 132, Address: 0x1a0eb8, Func Offset: 0x88
	// Line 134, Address: 0x1a0ec0, Func Offset: 0x90
	// Line 135, Address: 0x1a0ee0, Func Offset: 0xb0
	// Line 137, Address: 0x1a0ee8, Func Offset: 0xb8
	// Line 138, Address: 0x1a0f04, Func Offset: 0xd4
	// Line 140, Address: 0x1a0f14, Func Offset: 0xe4
	// Line 141, Address: 0x1a0f34, Func Offset: 0x104
	// Line 143, Address: 0x1a0f3c, Func Offset: 0x10c
	// Line 144, Address: 0x1a0f4c, Func Offset: 0x11c
	// Line 145, Address: 0x1a0f5c, Func Offset: 0x12c
	// Func End, Address: 0x1a0f70, Func Offset: 0x140
}

// zPendulum_Setup__FP10_zPendulumP7_xScene
// Start address: 0x1a0f70
void zPendulum_Setup(_zPendulum* pend, _xScene* sc)
{
	// Line 112, Address: 0x1a0f70, Func Offset: 0
	// Line 113, Address: 0x1a0f84, Func Offset: 0x14
	// Line 115, Address: 0x1a0f8c, Func Offset: 0x1c
	// Line 116, Address: 0x1a0f98, Func Offset: 0x28
	// Func End, Address: 0x1a0fac, Func Offset: 0x3c
}

// zPendulum_Load__FP10_zPendulumP7xSerial
// Start address: 0x1a0fb0
void zPendulum_Load(_zPendulum* pend, xSerial* s)
{
	// Line 104, Address: 0x1a0fb0, Func Offset: 0
	// Func End, Address: 0x1a0fb8, Func Offset: 0x8
}

// zPendulum_Save__FP10_zPendulumP7xSerial
// Start address: 0x1a0fc0
void zPendulum_Save(_zPendulum* pend, xSerial* s)
{
	// Line 85, Address: 0x1a0fc0, Func Offset: 0
	// Func End, Address: 0x1a0fc8, Func Offset: 0x8
}

// zPendulum_Init__FPvPv
// Start address: 0x1a0fd0
void zPendulum_Init(void* pend, void* asset)
{
	// Line 29, Address: 0x1a0fd0, Func Offset: 0
	// Line 30, Address: 0x1a0fe0, Func Offset: 0x10
	// Line 31, Address: 0x1a1058, Func Offset: 0x88
	// Func End, Address: 0x1a106c, Func Offset: 0x9c
}
