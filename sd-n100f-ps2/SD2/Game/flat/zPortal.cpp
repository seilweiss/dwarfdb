...
typedef void(*type_4)(_xEnt*, _xScene*, float32, _xEntCollis*);
typedef void(*type_5)(_xEnt*, _xScene*, float32);
typedef void(*type_8)(_xEnt*, _xVec3*);
typedef void(*type_11)(_xEnt*, _xScene*, float32, _xEntFrame*);
typedef uint32(*type_12)(_xEnt*, _xEnt*, _xScene*, float32, _xCollis*);
typedef void(*type_13)(_xEnt*);
typedef RpAtomic*(*type_15)(RpAtomic*);
typedef int32(*type_16)(RxPipelineNode*, RxPipelineNodeParam*);
typedef void(*type_17)(int32);
...
typedef xBase*(*type_59)(uint32);
typedef int8*(*type_60)(xBase*);
typedef int8*(*type_62)(uint32);
...
typedef zGlobalGameStats type_1[4];
typedef int32 type_3[2];
...
typedef zCutsceneZbuffer type_23[4];
...
typedef uint32 type_35[2];
typedef uint32 type_36[43];
typedef uint32 type_37[2];
typedef xBase* type_39[43];
typedef _xCollis type_40[18];
...
typedef _xVec3 type_67[2];
typedef float32 type_68[15];
typedef _xVec4 type_69[8];
typedef iModelTag type_70[4];
typedef uint32 type_71[15];
typedef _xQuat type_72[2];
typedef int8 type_77[128];
typedef int8 type_78[128][6];
typedef _xVec3 type_79[4];
...
typedef zGlobalGameStats type_96[13];
...
// zPortalEventCB__FP5xBaseP5xBaseUiPfP5xBase
// Start address: 0x1a0360
int32 zPortalEventCB(xBase* to, uint32 toEvent)
{
	// Line 101, Address: 0x1a0360, Func Offset: 0
	// Line 105, Address: 0x1a0364, Func Offset: 0x4
	// Line 108, Address: 0x1a0384, Func Offset: 0x24
	// Line 109, Address: 0x1a0394, Func Offset: 0x34
	// Line 112, Address: 0x1a039c, Func Offset: 0x3c
	// Line 114, Address: 0x1a03ac, Func Offset: 0x4c
	// Line 120, Address: 0x1a03b4, Func Offset: 0x54
	// Line 119, Address: 0x1a03b8, Func Offset: 0x58
	// Line 120, Address: 0x1a03bc, Func Offset: 0x5c
	// Func End, Address: 0x1a03c4, Func Offset: 0x64
}

// zPortalLoad__FP8_zPortalP7xSerial
// Start address: 0x1a03d0
void zPortalLoad(_zPortal* ent, xSerial* s)
{
	// Line 82, Address: 0x1a03d0, Func Offset: 0
	// Func End, Address: 0x1a03d8, Func Offset: 0x8
}

// zPortalSave__FP8_zPortalP7xSerial
// Start address: 0x1a03e0
void zPortalSave(_zPortal* ent, xSerial* s)
{
	// Line 64, Address: 0x1a03e0, Func Offset: 0
	// Func End, Address: 0x1a03e8, Func Offset: 0x8
}
...
void zPortalInit(void* portal, void* passet)
{
	// Line 23, Address: 0x1a03f0, Func Offset: 0
	// Line 24, Address: 0x1a0404, Func Offset: 0x14
	// Line 25, Address: 0x1a0434, Func Offset: 0x44
	// Func End, Address: 0x1a0448, Func Offset: 0x58
}
