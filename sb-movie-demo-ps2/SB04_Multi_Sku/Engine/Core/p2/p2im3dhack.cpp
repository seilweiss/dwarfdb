...
typedef int32(*type_4)(RxPS2AllPipeData*);
typedef int32(*type_5)(RxPS2AllPipeData*);
typedef int32(*type_6)(RxPS2AllPipeData*, void**, uint32);
...
typedef RwResEntry* type_9[1];
typedef int8 type_14[32];
typedef int8 type_15[32];
typedef rwPS2AllFieldRec type_18[12];
...
// Start address: 0x1cd770
void p2EnableFastIm3D()
{
	// Line 92, Address: 0x1cd770, Func Offset: 0
	// Func End, Address: 0x1cd778, Func Offset: 0x8
}
