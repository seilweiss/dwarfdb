...
void* rwPDS_VCL_HICloneSkin_VU1Transforms[2];
RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneSkin_VU1Code;
RpPDSSkyMatTemplate rwPDS_VCL_HICloneSkin_MatPipe;
