...
typedef void(*type_0)(_rwResEntryTag*);
typedef int32(*type_1)(_RxPipelineNode*, _RxPipelineNodeParam*);
...
typedef _RwObjectHasFrame*(*type_9)(_RwObjectHasFrame*);
...
typedef _RwCamera*(*type_15)(_RwCamera*);
